...
- (BOOL)webView:(UIWebView *)localWebView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    NSDictionary *FPSettings = [NSDictionary dictionaryWithContentsOfFile:[[FPLibrary frameworkBundle] pathForResource:@"FilepickerSettings" ofType:@"plist"]];
    ...
    if ([[FPSettings valueForKey:@"OnlyResolveAllowedLinks"] boolValue]){
        ...
        NSArray *disallowedUrlPrefix = [NSArray arrayWithContentsOfFile:[[FPLibrary frameworkBundle] pathForResource:@"disallowedUrlPrefix" ofType:@"plist"]];
        
        NSArray *allowedUrlPrefix = [NSArray arrayWithContentsOfFile:[[FPLibrary frameworkBundle] pathForResource:@"allowedUrlPrefix" ofType:@"plist"]];
