...
- (BOOL)webView:(UIWebView *)localWebView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    NSLog([FPSettings[@"OnlyResolveAllowedLinks"] boolValue] ? @"HIDE LINKS" : @"DONT HIDE");
...
{
    [FPMBProgressHUD showHUDAddedTo:webView
                           animated:YES];
}

- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    [FPMBProgressHUD hideAllHUDsForView:webView
                               animated:YES];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    NSLog([FPSettings[@"HideAllLinks"] boolValue] ? @"HIDE LINKS" : @"DONT HIDE");

    if ([FPSettings[@"HideAllLinks"] boolValue])
    {
